    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a id="button" class="dropdown-item" href="#" value="Dubrovnik">Dubrovnik</a>
          ...
          <a id="button" class="dropdown-item" href="dodajSibenik.php" value="Sibenik">Sibenik</a>
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Putovanje</li>
    ...
    <div id="content-wrapper">
    <form action="dodajPutovanjeDubrovnik.php" method='post'>
